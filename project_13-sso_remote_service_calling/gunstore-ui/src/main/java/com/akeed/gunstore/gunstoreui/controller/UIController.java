package com.akeed.gunstore.gunstoreui.controller;

import com.akeed.gunstore.commons.model.Customer;
import com.akeed.gunstore.gunstoreui.config.AccessToken;
...
public class UIController extends WebSecurityConfigurerAdapter {
    ...
    public String loadCustomers(Model model) {
        ...
        try {
            ResponseEntity<Customer[]> responseEntity = restTemplate.exchange("http://localhost:8083/users/customers", HttpMethod.GET, customerHttpEntity, Customer[].class);
